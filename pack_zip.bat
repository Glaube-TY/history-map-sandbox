...
REM 多行用空格分隔
REM ============================================
set "FILES=.env.example .eslintrc.cjs .gitattributes .gitignore .github .prettierrc.json docs index.html package.json package-lock.json public README.md src tsconfig.app.json tsconfig.json tsconfig.node.json vite.config.ts"
